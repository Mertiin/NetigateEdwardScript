function onSelectRadioOnDropdownChange(dropdownId, radioId, bindings) {
...
function selectRadioOnDropdownChange(dropdownId, radioId, bindings) {
  $(dropdownId).change(function() {
    onSelectRadioOnDropdownChange(dropdownId, radioId, bindings)
  })
}
...
//     onSelectRadioOnDropdownChange('#ctl21_N-5-124409750', '#ctl22_N-3-124409767', bindings);
// })
